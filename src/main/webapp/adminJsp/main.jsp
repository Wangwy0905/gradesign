...
<script type="text/javascript" src="${pageContext.request.contextPath}/adminJsp/js/easyui-lang-zh_CN.js"></script>
    ...
    <script type="text/javascript" src="../adminJsp/js/jquery.edatagrid.js"></script>
    <script type="text/javascript" src="../adminJsp/js/easyui-lang-zh_CN.js"></script>
...
<script type="text/javascript">
                ...
                function(result){
                    ...
                    for(var i=0;i<result.length;i++){
                        ...
                        for(var j=0;j<second.length;j++){
                            a += "<p style='text-align: center'><a id=\"btn\" href=\"#\" class=\"easyui-linkbutton\" onclick=\"addTabs('" + second[j].title + "','" + second[j].id + "','" + second[j].iconcls + "','" + second[j].url + "')\">" + second[j].title + "</a></p>";
                        }
    ...
    function addTabs(title,id,iconcls,url){
        cateId=id;
        if( $("#tt").tabs("exists",title)){
            ...
            $("#tt").tabs("add",{
                title:title,
                iconCls:iconcls,
                href:"${pageContext.request.contextPath}/adminJsp/"+url,
                selected: true,
                closable:true
...
<body class="easyui-layout">   
    <div data-options="region:'north',split:true" style="height:60px;background-color:  #5C160C">
    	<div style="font-size: 24px;color: #FAF7F7;font-family: 楷体;font-weight: 900;width: 500px;float:left;padding-left: 20px;padding-top: 10px" >易瑞商家后台管理系统</div>
    ...
    <div data-options="region:'south',split:true" style="height: 40px;background: #5C160C">
    	<div style="text-align: center;font-size:15px; color: #FAF7F7;font-family: 楷体" >&copy;易瑞商家 个人邮箱</div>
    </div>   
